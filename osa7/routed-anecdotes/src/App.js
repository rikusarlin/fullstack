      ...
      <Router>
        <div>
          ...
          <Route exact path="/" render={() => 
            <AnecdoteList anecdotes={params.anecdotes} /> 
          } /> 
          <Route exact path="/anecdotes" render={() => 
            <AnecdoteList anecdotes={params.anecdotes} /> 
          } /> 
          <Route exact path="/anecdotes/:id" render={({ match }) => 
            <Anecdote anecdote={params.anecdoteById(match.params.id)} /> 
          } /> 
          <Route path="/create" render={() => 
            <CreateNew addNew={params.addNew} setNotification={params.setNotification}/>
          } />
...
const Anecdote = ( {anecdote} ) => {
  ...
  // console.log(`In Anecdote, parameter anecdote.content: ${anecdote.content}`)
  return(
    <div>
